...
namespace Calendar
{
	...
	{
		if (Fortnite_Version > 7 && Fortnite_Version < 7.40)
		{
	...
	static inline void SetWaterLevel(int WaterLevel)
	{
		...
		if (WL)
		{
			...
			if (FoundationSetup)
			{
				static auto SetWaterFoundations = FindObject<UFunction>(L"/Game/Athena/Apollo/Environments/Blueprints/Apollo_WaterSetup_Foundations.Apollo_WaterSetup_Foundations_C.SetWaterFoundations");
