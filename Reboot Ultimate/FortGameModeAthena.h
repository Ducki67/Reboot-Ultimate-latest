...
static inline UFortAbilitySet* GetPlayerAbilitySet()
{
	...
	static auto GameplayAbilitySet = (Fortnite_Version >= 8.30
		? LoadObject<UFortAbilitySet>(L"/Game/Abilities/Player/Generic/Traits/DefaultPlayer/GAS_AthenaPlayer.GAS_AthenaPlayer")
